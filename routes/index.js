...
// City Routes
router.get('/fetch-countries-and-cities', cityController.fetchCountriesAndCities);//for admin 
...
router.post('/create-payment-intent', paymentController.handleCreatePaymentIntent); // for user and admin
